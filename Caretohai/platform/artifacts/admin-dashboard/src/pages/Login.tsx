    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-emerald-50/30 p-4">
      <div className="w-full max-w-md space-y-4">
        <Card className="shadow-xl border-0 ring-1 ring-black/[0.06]">
          <CardHeader className="space-y-4 pb-6 text-center pt-8">
            ...
            <div className="space-y-1">
              <CardTitle className="text-2xl font-bold tracking-tight">AsaanCare Admin</CardTitle>
              <CardDescription className="text-sm font-medium text-emerald-600 text-base">آسان کیئر — صحت آپ کے گھر</CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="px-8 pb-8">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="admin@asaancare.pk"
            ...
            <div className="mt-6 rounded-xl bg-muted/60 border border-border/50 p-4 space-y-2">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <code className="font-mono text-xs bg-background rounded px-2 py-0.5 border select-all">superadmin@asaancare.pk</code>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">Password:</span>
                <code className="font-mono text-xs bg-background rounded px-2 py-0.5 border select-all">AsaanCare@2025!</code>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <p className="text-center text-xs text-muted-foreground">
          Restricted to authorized AsaanCare administrators only
        </p>
      </div>
    </div>
  );
