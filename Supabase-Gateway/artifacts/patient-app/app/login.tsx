      ...
      >
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.brand}>SahatGhar</Text>
...
const styles = StyleSheet.create({
  ...
  logoWrap: { width: 72, height: 72, borderRadius: 22, backgroundColor: "rgba(255,255,255,0.2)", alignItems: "center", justifyContent: "center", marginBottom: 12 },
  brand: { fontSize: 32, fontFamily: "Inter_700Bold", color: "#fff" },
  tagline: { fontSize: 15, color: "rgba(255,255,255,0.8)", marginTop: 4 },
  card: { backgroundColor: "#fff", borderRadius: 24, padding: 24, gap: 16, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.12, shadowRadius: 16, elevation: 8 },
