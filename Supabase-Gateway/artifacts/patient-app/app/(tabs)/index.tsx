      ...
      <View style={styles.section}>
        ...
        <View style={styles.quickActions}>
          ...
          >
            ...
            <Text style={[styles.actionLabel, { color: colors.foreground }]}>Prescriptions</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  actionCard: { flex: 1, borderRadius: 16, borderWidth: 1, padding: 16, alignItems: "center", gap: 8 },
