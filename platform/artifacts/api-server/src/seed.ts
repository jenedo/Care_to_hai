...
async function main() {
  ...
  // ── ADMIN USERS ───────────────────────────────────────────────────────────
  const adminPassHash = await bcrypt.hash("AsaanCare@2025!", 12);

  const adminData = [
    { email: "superadmin@asaancare.pk", fullName: "Ayesha Malik", role: "SUPER_ADMIN" as const },
    { email: "admin@asaancare.pk", fullName: "Usman Khan", role: "ADMIN" as const },
    { email: "finance@asaancare.pk", fullName: "Sana Iman", role: "FINANCE" as const },
    { email: "support@asaancare.pk", fullName: "Bilal Ahmed", role: "SUPPORT" as const },
    { email: "verifier@asaancare.pk", fullName: "Hina Fatima", role: "VERIFICATION_OFFICER" as const },
  ];
  ...
  console.log("✓ Created 5 admin users (password: AsaanCare@2025!)");
  ...
  const doctorData = [
    { fullName: "Dr. Ayesha Noor", email: "ayesha.noor@asaancare.pk", specialty: "Cardiology", city: "Lahore", pmdcNumber: "79484-P", verificationStatus: "VERIFIED" as const, fee: "1500", rating: "4.8", appts: 156, featured: true },
    { fullName: "Dr. Usman Tariq", email: "usman.tariq@asaancare.pk", specialty: "General Medicine", city: "Karachi", pmdcNumber: "454321-P", verificationStatus: "PENDING" as const, fee: "800", rating: null, appts: 0, featured: false },
    { fullName: "Dr. Hina Fatima", email: "hina.fatima@asaancare.pk", specialty: "Dermatology", city: "Islamabad", pmdcNumber: "112233-P", verificationStatus: "IN_REVIEW" as const, fee: "1200", rating: null, appts: 0, featured: false },
    { fullName: "Dr. Bilal Ahmad", email: "bilal.ahmad@asaancare.pk", specialty: "Orthopedics", city: "Rawalpindi", pmdcNumber: "334400-P", verificationStatus: "VERIFIED" as const, fee: "2000", rating: "4.6", appts: 89, featured: false },
    { fullName: "Dr. Sana Khan", email: "sana.khan@asaancare.pk", specialty: "Pediatrics", city: "Multan", pmdcNumber: "556677-P", verificationStatus: "VERIFIED" as const, fee: "1000", rating: "4.7", appts: 203, featured: true },
    { fullName: "Dr. Farhan Malik", email: "farhan.malik@asaancare.pk", specialty: "ENT", city: "Peshawar", pmdcNumber: "667788-P", verificationStatus: "VERIFIED" as const, fee: "1300", rating: "4.5", appts: 134, featured: false },
    { fullName: "Dr. Maryam Siddiqui", email: "maryam.siddiqui@asaancare.pk", specialty: "Gynecology", city: "Lahore", pmdcNumber: "778899-P", verificationStatus: "SUSPENDED" as const, fee: "1500", rating: "3.2", appts: 45, featured: false },
    { fullName: "Dr. Hassan Malik", email: "hassan.malik@asaancare.pk", specialty: "Neurology", city: "Karachi", pmdcNumber: "889900-P", verificationStatus: "PENDING" as const, fee: "2500", rating: null, appts: 0, featured: false },
    { fullName: "Dr. Faisal Mahmood", email: "faisal.mahmood@asaancare.pk", specialty: "General Medicine", city: "Lahore", pmdcNumber: "990011-P", verificationStatus: "VERIFIED" as const, fee: "900", rating: "4.9", appts: 312, featured: true },
    { fullName: "Dr. Fatima Noor", email: "fatima.noor@asaancare.pk", specialty: "Psychiatry", city: "Islamabad", pmdcNumber: "112244-P", verificationStatus: "VERIFIED" as const, fee: "1800", rating: "4.7", appts: 178, featured: false },
    { fullName: "Dr. Ahmed Raza", email: "ahmed.raza@asaancare.pk", specialty: "Cardiology", city: "Karachi", pmdcNumber: "223355-P", verificationStatus: "VERIFIED" as const, fee: "1500", rating: "4.8", appts: 95, featured: false },
    { fullName: "Dr. Zainab Hassan", email: "zainab.hassan@asaancare.pk", specialty: "Ophthalmology", city: "Lahore", pmdcNumber: "445566-P", verificationStatus: "PENDING" as const, fee: "1100", rating: null, appts: 0, featured: false },
    { fullName: "Dr. Omar Khalid", email: "omar.khalid@asaancare.pk", specialty: "Urology", city: "Karachi", pmdcNumber: "556699-P", verificationStatus: "VERIFIED" as const, fee: "2200", rating: "4.6", appts: 67, featured: false },
    { fullName: "Dr. Sara Imran", email: "sara.imran@asaancare.pk", specialty: "Endocrinology", city: "Islamabad", pmdcNumber: "667711-P", verificationStatus: "IN_REVIEW" as const, fee: "1700", rating: null, appts: 0, featured: false },
    { fullName: "Dr. Kamran Shah", email: "kamran.shah@asaancare.pk", specialty: "Gastroenterology", city: "Lahore", pmdcNumber: "778822-P", verificationStatus: "VERIFIED" as const, fee: "1900", rating: "4.4", appts: 112, featured: false },
    { fullName: "Dr. Nadia Qureshi", email: "nadia.qureshi@asaancare.pk", specialty: "Rheumatology", city: "Karachi", pmdcNumber: "889933-P", verificationStatus: "REJECTED" as const, fee: "1600", rating: null, appts: 0, featured: false },
    { fullName: "Dr. Tariq Mahmood", email: "tariq.mahmood@asaancare.pk", specialty: "Pulmonology", city: "Peshawar", pmdcNumber: "990044-P", verificationStatus: "VERIFIED" as const, fee: "1400", rating: "4.5", appts: 88, featured: false },
    { fullName: "Dr. Rabia Akhtar", email: "rabia.akhtar@asaancare.pk", specialty: "Nephrology", city: "Multan", pmdcNumber: "112255-P", verificationStatus: "PENDING" as const, fee: "2100", rating: null, appts: 0, featured: false },
    { fullName: "Dr. Imran Baig", email: "imran.baig@asaancare.pk", specialty: "Oncology", city: "Lahore", pmdcNumber: "223366-P", verificationStatus: "VERIFIED" as const, fee: "3000", rating: "4.9", appts: 54, featured: true },
    { fullName: "Dr. Asma Shahid", email: "asma.shahid@asaancare.pk", specialty: "Allergy & Immunology", city: "Islamabad", pmdcNumber: "334477-P", verificationStatus: "VERIFIED" as const, fee: "1300", rating: "4.6", appts: 143, featured: false },
  ];
  ...
  console.log("   Super Admin: superadmin@asaancare.pk / AsaanCare@2025!");
  console.log("   Admin:       admin@asaancare.pk / AsaanCare@2025!");
  console.log("   Finance:     finance@asaancare.pk / AsaanCare@2025!");
  console.log("   Support:     support@asaancare.pk / AsaanCare@2025!");
  console.log("   Verifier:    verifier@asaancare.pk / AsaanCare@2025!");
