...
router.get("/subscriptions/my/usage", requirePatientAuth, async (req, res): Promise<void> => {
...
router.get("/subscriptions/my/members", requirePatientAuth, async (req, res): Promise<void> => {
  const patientId = await getCurrentPatientId(req);
  const activeSubscription = await findActiveSubscriptionForPatient(patientId);
...
router.post("/subscriptions/my/members", requirePatientAuth, async (req, res): Promise<void> => {
  const patientId = await getCurrentPatientId(req);
  const activeSubscription = await findActiveSubscriptionForPatient(patientId);
...
router.post("/subscriptions/my/members/:id/accept", requirePatientAuth, async (req, res): Promise<void> => {
  const patientId = await getCurrentPatientId(req);
...
router.post("/subscriptions/usage/reserve", requirePatientAuth, async (req, res): Promise<void> => {
  const patientId = await getCurrentPatientId(req);
  const body = readBodyObject(req.body);
...
router.post("/subscriptions/usage/:id/start", requirePatientAuth, async (req, res): Promise<void> => {
  const patientId = await getCurrentPatientId(req);
...
router.post("/subscriptions/usage/:id/complete", requirePatientAuth, async (req, res): Promise<void> => {
  const patientId = await getCurrentPatientId(req);
  const usageId = readRouteParam(req.params.id, "Usage id");
  const body = readBodyObject(req.body);
  const usage = await assertUsageBelongsToCurrentPatient(usageId, patientId);
...
router.post("/subscriptions/usage/:id/cancel", requirePatientAuth, async (req, res): Promise<void> => {
  const patientId = await getCurrentPatientId(req);
  const usageId = readRouteParam(req.params.id, "Usage id");
  const usage = await assertUsageBelongsToCurrentPatient(usageId, patientId);
